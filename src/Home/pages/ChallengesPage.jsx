        ...
        <HomeLayout>
            <div>
                <div className="startRadial">
                    ...
                    <div className="row d-flex justify-content-center align-items-center mt-5" style={{
                        ...
                        <div class="card mb-3" style={{ width: 1200}}>
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div className="col-md-8">
                                    <div className="card-body">
                                        ...
                                        <div className="d-flex justify-content-between">
                                            ...
                                            <div>
                                                <h6 style={{ fontSize: 22, fontWeight: 600 }}>Plazas:</h6>
                                                <p style={{ color: 'green', fontWeight: 600 }}>DISPONIBLE</p>
                                            </div>
                                            <div>
